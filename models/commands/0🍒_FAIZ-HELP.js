...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "FAIZ ANSARI",
  description: "THIS BOT IS MR FAIZ ANSARI",
...
const first = numberOfOnePage * page - numberOfOnePage;
    ...
    const siu = `╭══❁🌺[ LIST OF COMMANDS  𒁍╭═══❁🌺\n╭═══❁🌺 NAME  𒁍 ${global.config.BOTNAME}\n╭═══❁🌺 PAGE  𒁍 ｢${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}｣\n╰•┄┅═════════❁🌺`;
 ...
 const text = `╭•┄┅════════════❁🌺\n╭═══❁🌺 ${global.config.BOTNAME}\n╭═══❁🌺 COMMAND LIST  𒁍 ${arrayInfo.length}\n╭═══❁🌺 NAME  𒁍 ${global.config.BOTNAME}\n╭═══❁🌺 PREFIX  𒁍 ${global.config.PREFIX}\n╰•┄┅════════════❁🌺  𒁍 MY HELP 2 👉`;
    var link = [
"https://i.imgur.com/5iwOwZ0.jpeg",      
"https://i.imgur.com/6R9JjQ6.jpeg",    
"https://i.imgur.com/0sNpckZ.png",
"https://i.imgur.com/2xF9nc1.jpeg",
    ]
...
const leiamname = getText("moduleInfo", command.config.name, command.config.description, `${(command.config.usages) ? command.config.usages : ""}`, command.config.commandCategory, command.config.cooldowns, ((command.config.hasPermssion == 0) ? getText("user") : (command.config.hasPermssion == 1) ? getText("adminGroup") : getText("adminBot")), command.config.credits);
  ...
  var link = [
"https://i.imgur.com/9NdNkaN.jpeg",
  ]
